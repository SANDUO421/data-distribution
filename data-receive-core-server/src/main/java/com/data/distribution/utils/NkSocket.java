...
/**
 * @description: socket获取数据
 * @author: sanduo
 * @date: 2019/11/20 20:05
 * @version: 1.0
 */
public class NkSocket implements Callable<String> {
...
//            dataOutputStream.writeUTF("tourist,tourist@#lydsj");
    ...
    public String call() throws Exception {
        while (true) {
            ...
            if (!this.close) {
                return this.ReadAndSaveText(this.socket);
            }
...
//    }
    ...
    public String ReadAndSaveText(Socket csocket) {
        String line = "";
        try {
